...
{
    public partial class IntialProductSeeding : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoritePart = table.Column<string>(type: "text", nullable: true),
                    LeastFavoritePart = table.Column<string>(type: "text", nullable: true),
                    WhatDidWeDoWell = table.Column<string>(type: "text", nullable: true),
                    WhatWeDidNotDoWell = table.Column<string>(type: "text", nullable: true),
                    AnotherProject = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersAddress_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "66af6557-24d9-4eb7-a99b-be1d3c9d98e0", "Member", "MEMBER" },
                    { 2, "32335e7b-5654-4277-b8fc-7b38f81b0f7e", "Admin", "ADMIN" }
                });
