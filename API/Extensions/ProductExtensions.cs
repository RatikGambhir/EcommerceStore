...
namespace API.Extensions
{
    public static class ProductExtensions
    {
        ...
        public static IQueryable<Product> SearchByName(this IQueryable<Product> query, string searchName) {
        ...
        public static IQueryable<Product> FilterProducts(this IQueryable<Product> query, string brands, string types) {
